...
public class DatartHome extends Page implements IHome {
    ...
    public DatartHome(WebDriver drv) {
        super(drv);
    }
     ...
     * asking for this agreement. Method without specific option represents default
     ...
     *
     * @param isMandatory is mandatory always confirm this agreement
     */
    @Override
